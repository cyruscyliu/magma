  ...
  public:
    ...
    bool runOnModule(Module &M) override {
      ...
      GlobalVariable *CovMapPtr = new GlobalVariable(
        M, Int8PtrTy, false, GlobalValue::ExternalLinkage, nullptr,
        "__afl_area_ptr");
      ...
      for (Function &F : M) {
        ...
        for (BasicBlock &BB : F) {
          ...
          LoadInst *PrevLoc = IRB.CreateLoad(Int32Ty, OldPrev);
          Value *PrevLocCasted = IRB.CreateZExt(PrevLoc, IRB.getInt32Ty());

          LoadInst *MapPtr = IRB.CreateLoad(Int8PtrTy, CovMapPtr);
